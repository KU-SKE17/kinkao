...
public class ReviewService {
    ...
    public ReviewRequest createReview(ReviewRequest review) {
        ...
        ResponseEntity<ReviewRequest> response = restTemplate.exchange(url, HttpMethod.POST, entity, ReviewRequest.class);
    ...
    public List<ReviewResponse> getRestaurantReview(UUID restaurantId) {
        ...
        ResponseEntity<ReviewResponse[]> response = restTemplate.exchange(url, HttpMethod.GET, entity, ReviewResponse[].class);
